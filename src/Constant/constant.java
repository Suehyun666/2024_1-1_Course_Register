...
public class constant {
	   public static class login {
	        ...
	        public static final int LOGIN_PANEL_HEIGHT = HEIGHT;
	        ...
	        public static final int IMAGE_PANEL_HEIGHT = HEIGHT;
	        
	        // image path
	        public static final String IMAGE_PATH = "image/adblock.png";
	        public static final String BACKIMAGE_PATH = "image/0000.png";
	...
	public class mainframe {
        ...
        final public static String MY="My Lecture";
	...
	public class lecture {
		...
		final public static long VERSION_NUM=1L;	
		final public static String MIRI="BAKSET";
		final public static String DELETEMIRI="DELETEMIRI";
	...
	public class my{
		final public static long VERSION_NUM=1L;
		final public static String DEL="Delete";
	}
	public class search{
		final public static long VERSION_NUM=1L;
		final public static String GO="go";
	...
	public class dao{
		//
		final public static String ASK="수강신청";
		final public static String DRIVER = "com.mysql.cj.jdbc.Driver";
		final public static String JDBC_URL = "jdbc:mysql://localhost:3306/student";
		final public static String USERNAME = "root";
		final public static String PASSWORD = "0000";
		...
		public static final String BASKET="basket";
		public static final String DELBASKET="Delete Basket";
		public static final String DELETE = "Delete";
	}
